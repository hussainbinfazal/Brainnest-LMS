...
// import { Chat, ClientToServerEvents, Message, ServerToClientEvents } from "@/types/client";
// import { Socket } from "socket.io-client";
// import { ISelectedPlan } from "../ChatPageComp";
// export default function ChatIdPageComp() : React.JSX.Element{
...
//   const [socket, setSocket] = useState<Socket<ClientToServerEvents> | null>(null);
...
//                     <Button className='' size='' variant="outline">Back</Button>
//                     <Button className='' variant='' size=''>Pay Now</Button>
//                   </CardFooter>
//                 </Card>
//               </div>
//             </div>

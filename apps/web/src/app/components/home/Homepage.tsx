  ...
  return (
    <main className={cn("flex  items-center justify-center min-h-screen  pb-20 gap-10 font-(family-name:--font-geist-sans) dark:bg-black bg-white", className)}>
      <section className="w-full max-w-4/5 min-w-0  flex flex-col justify-center items-center gap-6 overflow-hidden">
        ...
        {/* HeroSection */}
        <section className="min-w-4/5 max-w-4/5 flex items-center justify-center ">
          <div className="flex flex-col items-center justify-center w-full ">
            {(<Carousel plugins={[]} className="">
              <CarouselContent className={"w-full"}>
                {allCourses.map((course: CCourse) => (
        ...
        {/* skill section */}
        {(<section className=" w-full flex items-center justify-center gap-4 bg-brand-white dark:bg-black overflow-hidden">
          ...
          {(
            <div className="w-full"><div className="mb-4 flex flex-col gap-2 w-full h-full">
              ...
              <div className="w-full ">
                ...
                >
                  <CarouselContent className="w-full -ml-1">
                    {shuffledCourses.length > 0 && (shuffledCourses || []).map((course: CCourse, index: number) => (

  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" className="outline-none shadow-none bg-transparent border-none hover:bg-transparent cursor-pointer dark:border-none" size="icon">
      ...
      <DropdownMenuContent className="" align="end">
        <DropdownMenuItem className="" inset="" onClick={() => setTheme("light")}>
          Light
        </DropdownMenuItem>

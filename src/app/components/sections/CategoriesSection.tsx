...
import { CCarouselOptions, CCategoriesSectionProps } from "@/types/client";

export default function CategoriesSection({ categories: categories, isLoading: isLoading }: CCategoriesSectionProps) {
